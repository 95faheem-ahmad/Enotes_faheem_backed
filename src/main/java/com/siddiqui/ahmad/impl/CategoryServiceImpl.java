...
public class CategoryServiceImpl implements CategoryService {
	...
	public Boolean saveCategory(CategoryDto categoryDto)   {
		...
		Boolean existsByName = categoryRepo.existsByName(categoryDto.getName().trim().toLowerCase());
	...
	public List<CategoryDto> getAllCategory() {
		...
		List<CategoryDto> dtoList = categories.stream().map(cat -> modelMapper.map(cat, CategoryDto.class))
	...
	public CategoryDto getCategoryById(Integer id) throws ResourceNotFoundException {
		...
		Optional<Category> optional = Optional.of(categoryRepo.findByIdAndIsDeletedFalse(id)
